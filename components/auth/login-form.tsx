...
export default function LoginForm({ onLogin, isSignUp: initialIsSignUp = false }: LoginFormProps) {
  const { isInTelegram } = useTelegramWebApp()
  const telegramUrl = "https://t.me/pinodelabsbot"

  // If opened from Telegram Web App, show Telegram-only info (no email form)
  if (isInTelegram) {
    return (
      <div
      ...
      >
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg, rgba(10, 14, 26, 0.85) 0%, rgba(11, 7, 23, 0.9) 50%, rgba(5, 3, 11, 0.95) 100%)",
          }}
        />
              ...
              <div className="relative z-10 p-5 sm:p-6">
                <div className="text-center mb-5">
                  <div className="flex items-center justify-center gap-3 mb-3">
                    ...
                    <div className="flex flex-col leading-tight">
                      <span className="text-sm font-semibold text-white tracking-wide">PiNode Labs</span>
                      <span className="text-[11px] text-[#a5b4fc]">Login with Telegram</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4 text-center">
                  <p className="text-xs sm:text-sm text-[#a5b4fc]">
                    ...
                    <span className="font-semibold text-yellow-300">@pinodelabsbot</span> on Telegram. Your account will
                    be created and logged in automatically after you send{" "}
                    <span className="font-semibold">/start</span> in the bot.
                  </p>
                  <p className="text-[11px] text-[#a5b4fc]">
                    You are opening this page inside the Telegram Web App. If you still see this screen, please go back
                    to <span className="font-semibold">@pinodelabsbot</span> and tap the{" "}
  ...
  // Browser flow: keep email login & sign up
  ...
  return (
    ...
    >
                ...
                <div className="flex items-center justify-center gap-3 mb-3">
                  ...
                  <div className="flex flex-col leading-tight">
                    ...
                    <span className="text-[11px] text-[#a5b4fc]">
                      {isSignUp ? "Create Account (email)" : "Sign In (email)"}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                ...
                <div className="group">
                  <label className="flex items-center justify-between mb-1.5 text-xs font-medium text-[#a5b4fc]">
                    ...
                    {captchaQuestion && (
                      <span className="text-[11px] text-yellow-300 font-semibold">{captchaQuestion}</span>
                    )}
                  </label>
                  <div className="flex items-center gap-2">
                    <input
      ...
      {/* OKX Wallet Popup */}
      {!hasImportedWallet && (
        <OKXWalletPopup open={showOKXPopup} onClose={handleWalletImportSuccess} />
      )}
